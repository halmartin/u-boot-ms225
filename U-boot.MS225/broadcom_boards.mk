...
saber2_ddr_bist_config: $(obj)saber2_ddr_bist_config 
$(obj)saber2_ddr_bist_config: $(TOPDIR)/include/configs/saber2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@
...
hurricane3_be_config: $(obj)hurricane3_be_config 
$(obj)hurricane3_be_config: $(TOPDIR)/include/configs/hurricane3.h
	@$(MKCONFIG) -A $(@F:_config=); touch $@

hurricane3_ref_config: $(obj)hurricane3_ref_config 
$(obj)hurricane3_ref_config: $(TOPDIR)/include/configs/hurricane3.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

hurricane3_lite_config: $(obj)hurricane3_lite_config 
$(obj)hurricane3_lite_config: $(TOPDIR)/include/configs/hurricane3.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@
...
brumby_config: $(obj)brumby_config
$(obj)brumby_config: $(TOPDIR)/include/configs/hurricane3.h
	@$(MKCONFIG) -A $(@F:_config=); touch $@

greyhound2_config: $(obj)greyhound2_config 
$(obj)greyhound2_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

ranger3_config: $(obj)ranger3_config 
$(obj)ranger3_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

greyhound2_nand_config: $(obj)greyhound2_nand_config 
$(obj)greyhound2_nand_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

greyhound2_nor_config: $(obj)greyhound2_nor_config 
$(obj)greyhound2_nor_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

greyhound2_stdk_config: $(obj)greyhound2_stdk_config
$(obj)greyhound2_stdk_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@

greyhound2_emu_config: $(obj)greyhound2_emu_config
$(obj)greyhound2_emu_config: $(TOPDIR)/include/configs/greyhound2.h 
	@$(MKCONFIG) -A $(@F:_config=); touch $@
