...
typedef volatile struct _gmacregs {
	...
	uint32_t        pfc_off_timer;          /* 0x860 */
	uint32_t        eee_ctrl;               /* 0x864 */
	uint32_t        mii_eee_delay_timer;    /* 0x868 */
	uint32_t        gmii_eee_delay_timer;   /* 0x86c */
	uint32_t        eee_ref_count;          /* 0x870 */
	uint32_t		PAD;                    /* 0x874 */
	uint32_t        rx_pkt_drop;            /* 0x878 */
	uint32_t        rx_idle_threshold ;     /* 0x87c */
	uint32_t        mii_eee_wake_timer;     /* 0x880 */
	uint32_t        gmii_eee_wake_timer;    /* 0x884 */
	uint32_t        revision_id;            /* 0x888 */
	uint32_t		PAD[157];				/* 0x88c-0xafc */
