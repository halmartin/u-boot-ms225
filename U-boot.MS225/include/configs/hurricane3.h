...
#define CONFIG_LOADADDR 0x70000000
...
#else /* defined(CONFIG_IPROC_NO_DDR) */
#if (defined(CONFIG_DDR32) && defined(CONFIG_IPROC_DDR_ECC))
#error "Hurricane3 doesn't support 32-bit DDR with ECC."
#endif
...
#define CONFIG_SYS_INIT_SP_ADDR             (CONFIG_PHYS_SDRAM_0 + CONFIG_IPROC_SRAM_SIZE - 0x2000 - 16)
...
#define CONFIG_DDR_BANK_GROUP_BITS          1
...
#define CONFIG_POST         (CONFIG_SYS_POST_MEMORY|CONFIG_SYS_POST_QSPI |\
                             CONFIG_SYS_POST_UART | CONFIG_SYS_POST_ETHER)
#else
...
#elif defined(CONFIG_IPROC_EMULATION)
...
#define CONFIG_EXTERNAL_PHY_DEV_ID              0x1
#endif /* CONFIG_HURRICANE3_LITE */
...
#define CONFIG_SHMOO_REUSE_QSPI_OFFSET          0x000F0000
...
#define CONFIG_BOOTCOMMAND                  "i2c mw 0x26 0x3 0x00 0x1; sleep 1; i2c mw 0x26 0x3 0xff 0x1;" \
                                            "sf probe 0;" \
                                            "sf read $loadaddr 0x100000 0x700000; bootm $loadaddr#config@brumby;" \
                                            "sf read $loadaddr 0x800000 0x700000; bootm $loadaddr#config@brumby;" \
                                            "sleep 30;" \
                                            "reset\0"
