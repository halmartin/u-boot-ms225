...
#define SDHCI_QUIRK_MISSING_CAPS    (1 << 9)
#define SDHCI_QUIRK_FORCE_DRIVER_STRENGTH   (1 << 10)

/* Driver strength type */
#define SDHCI_DRIVER_TYPE_B         0
#define SDHCI_DRIVER_TYPE_A	        1
#define SDHCI_DRIVER_TYPE_C	        2
#define SDHCI_DRIVER_TYPE_D	        3
